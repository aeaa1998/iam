<template>
  <div :class="{ dark: isDark }">
    ...
    <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
          ...
          <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
            ...
            <div>
              ...
              <a
                ...
                @click="
                  ...
                  isOpenComponentsSideBar = !isOpenComponentsSideBar;
                "
                ...
                :class="{ 'bg-blue-100 dark:bg-blue-600': isActiveComponentsSideBar || isOpenComponentsSideBar }"
                role="button"
                aria-haspopup="true"
                :aria-expanded="isOpenComponentsSideBar || isActiveComponentsSideBar ? 'true' : 'false'"
              >
                ...
                <span aria-hidden="true" class="ml-auto">
                  ...
                  <svg
                    ...
                    :class="{ 'rotate-180': isOpenComponentsSideBar }"
              ...
              <div v-if="isOpenComponentsSideBar" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                ...
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700">
                  Scope, Tiempo y Costo
                </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Calidad </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Riesgo </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Comunicaciones </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Recursos humanos </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Procedimientos </a>
              </div>
            </div>
            ...
            <div>
              ...
              <a
                ...
                @click="
                  $event.preventDefault();
                  isOpenPagesSideBar = !isOpenPagesSideBar;
                "
                class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600"
                :class="{ 'bg-blue-100 dark:bg-blue-600': isActivePagesSideBar || isOpenPagesSideBar }"
                role="button"
                aria-haspopup="true"
                :aria-expanded="isOpenPagesSideBar || isActivePagesSideBar ? 'true' : 'false'"
              >
                <span aria-hidden="true">
                  <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                ...
                <span aria-hidden="true" class="ml-auto">
                  ...
                  <svg
                    class="w-4 h-4 transition-transform transform"
                    :class="{ 'rotate-180': isOpenPagesSideBar }"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
              ...
              <div v-if="isOpenPagesSideBar" class="mt-2 space-y-2 px-7" role="menu" arial-label="Pages">
                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-700 transition-colors duration-200 rounded-md dark:text-light dark:hover:text-light hover:text-gray-700"> Blank </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:text-gray-400 dark:hover:text-light hover:text-gray-700"> Profile </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Pricing </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Kanban </a>
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Feed </a>
              </div>
            </div>
            ...
            <div>
              ...
              <a
                ...
                @click="
                  $event.preventDefault();
                  isOpenAuthSideBar = !isOpenAuthSideBar;
                "
                class="flex items-center p-2 text-gray-500 transition-colors rounded-md dark:text-light hover:bg-blue-100 dark:hover:bg-blue-600"
                :class="{ 'bg-blue-100 dark:bg-blue-600': isActiveAuthSideBar || isOpenAuthSideBar }"
                role="button"
                aria-haspopup="true"
                :aria-expanded="isOpenAuthSideBar || isActiveAuthSideBar ? 'true' : 'false'"
              >
                <span aria-hidden="true">
                  <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <span aria-hidden="true" class="ml-auto">
                  ...
                  <svg
                    class="w-4 h-4 transition-transform transform"
                    :class="{ 'rotate-180': isOpenAuthSideBar }"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
              ...
              <div v-if="isOpenAuthSideBar" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                ...
                <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Password Reset </a>
              </div>
            </div>
          </nav>
      ...
      <div class="flex flex-col flex-1 min-h-screen overflow-x-hidden overflow-y-auto">
        ...
        <header class="relative bg-white dark:bg-darker">
          <div class="flex items-center justify-between p-2 border-b dark:border-blue-800">
            ...
            <!-- Brand -->
            <a href="#" class="inline-block text-2xl font-bold tracking-wider text-blue-700 uppercase dark:text-light"> IAM-GT </a>
            ...
            <nav aria-label="Secondary" class="hidden space-x-2 md:flex md:items-center">
              ...
              <div class="relative">
                <button
                  ...
                  type="button"
                  aria-haspopup="true"
                  :aria-expanded="isOpenAvatar ? 'true' : 'false'"
                ...
                <div
                  ...
                  @click="isOpenAvatar = false"
                  @keydown.escape="isOpenAvatar = false"
                ...
                >
                  <a href="#" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-blue-600"> Your Profile </a>
                  <a href="#" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-blue-600"> Settings </a>
                  <a href="#" role="menuitem" class="block px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-100 dark:text-light dark:hover:bg-blue-600"> Logout </a>
                </div>
              </div>
            </nav>
            ...
            >
              <nav
                ...
                @click="isMobileSubMenuOpen = false"
          ...
          <!-- Mobile main manu -->
          <div class="border-b md:hidden dark:border-blue-800" v-if="isMobileMainMenuOpen" @click="isMobileMainMenuOpen = false">
            <nav aria-label="Main" class="px-2 py-4 space-y-2">
              ...
              <div>
                ...
                <div v-if="isOpenComponentsSideBar" class="mt-2 space-y-2 px-7" role="menu" arial-label="Components">
                  ...
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Cards </a>
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Dropdowns </a>
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Forms </a>
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Lists </a>
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Modals </a>
                </div>
              </div>
              ...
              <div>
                ...
                <div v-if="open" class="mt-2 space-y-2 px-7" role="menu" aria-label="Authentication">
                  <!-- active & hover classes 'text-gray-700 dark:text-light' -->
                  <!-- inActive classes 'text-gray-400 dark:text-gray-400' -->
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Register (soon) </a>
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Login (soon) </a>
                  <a href="#" role="menuitem" class="block p-2 text-sm text-gray-400 transition-colors duration-200 rounded-md dark:hover:text-light hover:text-gray-700"> Password Reset (soon) </a>
                </div>
              </div>
            </nav>
          </div>
        ...
        <div class="flex items-center justify-center flex-1 h-full p-4">
          <main class="space-y-4">HERE GOES CONTENT</main>
        </div>
      </div>
      ...
      >
        <div v-if="isSettingsPanelOpen" @click="isSettingsPanelOpen = false" class="fixed inset-0 z-10 bg-blue-800" style="opacity: 0.5" aria-hidden="true"></div>
      </transition>
      <!-- Panel -->
      <transition
                ...
                <div class="flex items-center space-x-8">
                  ...
                  <button
                    ...
                    class="
                      ...
                      dark:border-blue-700 dark:hover:text-blue-100 dark:hover:border-blue-500
                  ...
                  <button
                    ...
                    class="
                      ...
                      rounded-md
                      hover:text-gray-900 hover:border-gray-900
                      dark:border-blue-700 dark:hover:text-indigo-100 dark:hover:border-blue-500
                      focus:outline-none focus:ring focus:ring-blue-400
      ...
      <transition
        ...
        leave-to-class="opacity-0"
      >
        <div v-if="isNotificationsPanelOpen" @click="isNotificationsPanelOpen = false" class="fixed inset-0 z-10 bg-blue-800 bg-opacity-25" style="opacity: 0.5" aria-hidden="true"></div>
      </transition>
      <!-- Panel -->
      <transition
        enter-active-class="transition duration-300 ease-in-out transform sm:duration-500"
        ...
        >
          ...
          <div class="flex flex-col h-screen" x-data="{ activeTabe: 'action' }">
            ...
            <div class="flex-1 pt-4 overflow-y-hidden hover:overflow-y-auto">
              <!-- Action tab -->
              <div class="space-y-4" v-if="activeTabe == 'action'">
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      ...
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Looks like there might be a new theme soon</p>
                ...
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">KWD Dashboard v0.0.2 was released</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Successful new version was released</p>
              ...
              <!-- User tab -->
              <div class="space-y-4" v-if="activeTabe == 'user'">
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    <div class="relative flex-shrink-0">
                    ...
                    <div class="flex-1 overflow-hidden">
                      ...
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Shared new project "K-WD Dashboard"</p>
                ...
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Ahmed Kamel</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Commit new changes to K-WD Dashboard project.</p>
                ...
                <a href="#" class="block">
                  <div class="flex px-4 space-x-4">
                    ...
                    <div class="flex-1 overflow-hidden">
                      <h5 class="text-sm font-semibold text-gray-600 dark:text-light">Ahmed Kamel</h5>
                      <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Release new version "K-WD Dashboard"</p>
      ...
      <transition
        ...
        leave-to-class="opacity-0"
      >
        <div v-if="isSearchPanelOpen" @click="isSearchPanelOpen = false" class="fixed inset-0 z-10 bg-blue-800 bg-opacity-25" style="opacity: 0.5" aria-hidden="ture"></div>
      </transition>
      <!-- Panel -->
      <transition
        enter-active-class="transition duration-300 ease-in-out transform sm:duration-500"
            ...
            <div class="flex-1 px-4 pb-4 space-y-4 overflow-y-hidden font-sans h hover:overflow-y-auto">
              ...
              <a href="#" class="flex space-x-4">
                ...
                <div class="flex-1 max-w-xs overflow-hidden">
                  ...
                  <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Lorem ipsum dolor, sit amet consectetur.</p>
              ...
              <a href="#" class="flex space-x-4">
                ...
                <div class="flex-1 max-w-xs overflow-hidden">
                  ...
                  <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Last activity 3h ago.</p>
              ...
              <a href="#" class="flex space-x-4">
                ...
                <div class="flex-1 max-w-xs overflow-hidden">
                  ...
                  <p class="text-sm font-normal text-gray-400 truncate dark:text-blue-400">Lorem ipsum dolor, sit amet consectetur adipisicing elit.</p>
...
export default {
  ...
  data: () => ({
    ...
    isActiveComponentsSideBar: false,
    isOpenComponentsSideBar: false,
    isActivePagesSideBar: false,
    isOpenPagesSideBar: false,
    isActiveAuthSideBar: false,
    isOpenAuthSideBar: false,
    isOpenAvatar: false,
  }),
  methods: {
    setTheme(value) {
